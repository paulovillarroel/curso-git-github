...
<Callout type="tip" title="WSL / Ubuntu 24.04 / Linux">
  ...
  Si el paquete no se encuentra, necesitas agregar el repositorio oficial de GitHub CLI primero. Revisa las instrucciones en el Módulo 4 o en [cli.github.com](https://cli.github.com/).
</Callout>
