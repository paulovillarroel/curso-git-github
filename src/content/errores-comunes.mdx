...
<Callout type="warning" title="Esto borra todo sin preguntar">
...
<Callout type="tip" title="¿Solo quieres ver qué se borraría?">
...
<CommandTable commands={[
  ...
  { command: "git restore .", description: "Descartar TODOS los cambios no commiteados" },
  { command: "git clean -fd", description: "Borrar archivos y carpetas no rastreados" },
