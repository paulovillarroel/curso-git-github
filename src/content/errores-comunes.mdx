...
Si al hacer pull hay conflictos, resuélvelos como aprendiste en el Módulo 5 (editar el archivo, quitar los marcadores `<<<<<<<`, `=======`, `>>>>>>>`, hacer add y commit), y luego haz push.
