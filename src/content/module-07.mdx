...
En este módulo veremos primero el **camino de equipo** paso a paso. Al final verás el **camino de contribuidor externo**, que es casi idéntico: la única diferencia es que primero haces fork (como aprenderás en el Módulo 8) y el PR va desde tu fork al repo original.
