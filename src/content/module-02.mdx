...
**Git NO guarda copias completas de cada versión.** Es más inteligente que eso: internamente guarda solo las **diferencias** entre versiones (los "deltas"), lo que lo hace increíblemente eficiente. Un proyecto con miles de versiones puede ocupar menos espacio que unas pocas copias manuales de archivos zip.
...
<Callout type="warning" title="Usa el mismo correo que en GitHub">
  Cuando crees tu cuenta de GitHub (en el Módulo 6), usa el **mismo correo** que pusiste aquí. Así GitHub reconocerá tus contribuciones automáticamente.
</Callout>
...
No te preocupes si no entiendes qué son las "ramas" todavía. Lo veremos en el Módulo 5. Por ahora solo estamos dejando todo bien configurado.
