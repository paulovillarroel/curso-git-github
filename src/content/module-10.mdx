...
<Callout type="info" title="AGENTS.md es documentación viva">
  ...
  Para una guía completa con todo el contenido de este curso condensado para agentes de IA — incluyendo un template de AGENTS.md expandido con todas las secciones que puedes personalizar — revisa el archivo [GUIA-GIT-AGENTES-IA.md](https://github.com/paulovillarroel/curso-git-github/blob/main/GUIA-GIT-AGENTES-IA.md) en el repositorio del curso.
</Callout>
